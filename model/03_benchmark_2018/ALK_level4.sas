...
by age year area3 hy maxscm minscm;
run;
...
pi=n/s;
level=4;
keep age year area3 hy  maxp minp prange 
...
proc sort data=spr.alk_level4 out=t1;
by age year hy  scm;
run;
